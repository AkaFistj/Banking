...
int main() {
	...
	cin >> money;
			//проверка
		if (D < money || money % r50 != 0 || money == 0)
			{
		...
		if (money == 0)
		{
				cout << "Issued " << cash_0 * r5000 << " money. " << "Nominals: " << r5000 << ". Number of banknotes issued: " << cash_0 << endl;
				cout << "Issued " << cash_1 * r2000 << " money. " << "Nominals: " << r2000 << ". Number of banknotes issued: " << cash_1 << endl;
				cout << "Issued " << cash_2 * r1000 << " money. " << "Nominals: " << r1000 << ". Number of banknotes issued: " << cash_2 << endl;
				cout << "Issued " << cash_3 * r500 << " money. " << "Nominals: " << r500 << ". Number of banknotes issued: " << cash_3 << endl;
				cout << "Issued " << cash_4 * r200 << " money. " << "Nominals: " << r200 << ". Number of banknotes issued:: " << cash_4 << endl;
				cout << "Issued " << cash_5 * r100 << " money. " << "Nominals: " << r100 << ". Number of banknotes issued: " << cash_5 << endl;
				cout << "Issued " << cash_6 * r50 << " money. " << "Nominals: " << r50 << ". Number of banknotes issued: " << cash_6 << endl;
		}
		else
		{
				cout << endl << "Sorry, we have not enough notes of the desired value!" << endl;
				five_t = five_t + cash_0;
				two_t = two_t + cash_1;
				one_t = one_t + cash_2;
				five_h = five_h + cash_3;
				...
				D = (r5000 * five_t + r2000 * two_t + r1000 * one_t + r500 * five_h + r200 * two_h + r100 * one_h + r50 * fifty);
				cout << "Now balance in ATM:" << endl << "5000=" << five_t << " " << "2000=" << two_t << " " << "1000=" << one_t << " " << "500=" << five_h << " " << "200=" << two_h << " " << "100=" << one_h << " " << "50=" << fifty << endl << "The total amount of money = " << D << endl;
		}
